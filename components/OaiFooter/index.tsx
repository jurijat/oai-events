...
export default function OaiFooter() {
  return (
    <footer className="px-6 pb-0 md:px-20" style={{ backgroundColor: 'var(--brand-footer-bg)' }}>
      {/* Subscribe Section */}
      <section className="mx-auto max-w-[1360px] py-16 md:py-20">
        <div className="flex items-start gap-5">
          ...
          <div className="flex-1">
            ...
            <h2 className="m-0 mb-4 font-onest text-[32px] font-bold leading-[110%] tracking-oai text-[color:var(--ifm-font-color-base)] md:text-[48px]">
              Subscribe
            </h2>
            <p className="m-0 mb-8 max-w-[800px] font-onest text-lg font-normal leading-[120%] tracking-oai text-[color:var(--ifm-font-color-base)] md:text-[32px]">
            ...
            <div className="flex w-full max-w-[612px] flex-col items-start gap-2 sm:flex-row">
              <input
                type="email"
                placeholder="Email"
                className="placeholder:text-[color:var(--ifm-font-color-base)]/48 h-[64px] w-full rounded-[20px] border border-white/10 bg-brand-bg px-6 font-onest text-lg font-normal tracking-oai text-[color:var(--ifm-font-color-base)] outline-none sm:w-[480px]"
              />
              <button className="h-[64px] w-[124px] flex-shrink-0 cursor-pointer rounded-[20px] border-none bg-brand-green font-onest text-lg font-semibold tracking-oai text-black transition-all duration-200 hover:-translate-y-0.5 hover:bg-brand-green-light hover:shadow-[0_8px_24px_rgba(101,209,0,0.4)] active:translate-y-0 active:bg-brand-green-dark active:shadow-none disabled:pointer-events-none disabled:opacity-50">
                Subscribe
              </button>
            </div>
          </div>
      ...
      {/* Separator */}
      <div className="mx-auto h-px max-w-[1360px] bg-white/[0.04]" />
      ...
      <section className="mx-auto max-w-[1360px] py-16 md:py-20">
        <div className="flex items-start gap-5">
          ...
          <div className="flex-1">
            ...
            <h2 className="m-0 mb-10 font-onest text-[32px] font-bold leading-[110%] tracking-oai text-[color:var(--ifm-font-color-base)] md:text-[48px]">
              Follow updates on social media
            </h2>
      ...
      <div className="border-t border-white/[0.04]">
        <div className="mx-auto flex max-w-[1360px] flex-col items-start justify-between gap-4 py-6 md:flex-row md:items-center">
          <span className="font-onest text-lg font-normal tracking-oai text-brand-muted">
          ...
          <div className="flex flex-row items-center gap-10">
            <a
              ...
              className="font-onest text-lg font-normal tracking-oai text-brand-green no-underline hover:underline"
            >
              openapis.org
            </a>
            <a
              href="#"
              className="flex items-center gap-2 font-onest text-lg font-normal tracking-oai text-brand-green no-underline hover:underline"
            >
              <svg
                width="16"
                height="16"
